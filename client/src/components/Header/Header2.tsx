    ...
    <header className="bg-white  ">
      <nav aria-label="Global" className="mx-auto  self-center flex max-w-7xl items-center justify-between p-5 lg:px-20 ">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          { /* hier LINK aber klassen von a Tag übernehmen*/}
          <Link to={`/login`} className="text-sm font-semibold leading-6 text-gray-900">Login<span aria-hidden="true">&rarr;</span></Link>
